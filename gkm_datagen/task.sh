...
../../bin/gkmpredict -T25 ${dirname}.test.pos.coord.mult_species.at1.00/${species_index}_test_pos.fa species_model/species.${species_index}.model.txt ${species_index}.pos_predict || exit 1

../../bin/gkmpredict -T25 ${dirname}.test.neg.coord.mult_species.at1.00/${species_index}_test_neg.fa species_model/species.${species_index}.model.txt ${species_index}.neg_predict || exit 1
